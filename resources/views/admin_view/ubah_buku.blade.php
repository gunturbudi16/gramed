...
@section("judul","Ubah Buku")
@section("content")
	<form class="form-horizontal" method="post" action="{{url('admin/buku/ubah/'.$data->id_buku)}}" enctype="multipart/form-data">
		{{csrf_field()}}
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="txt_nama" name="txt_nama" type="text" placeholder="Nama Buku" class="form-control input-md" value="{{$data->nama_buku}}">
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <select id="cbo_kategori" name="cbo_kategori" class="form-control">
      ...
      <option value="{{$kat->id_kategori}}" @if($kat->id_kategori == $data->id_kategori) selected @endif>{{$kat->nama_kategori}}</option>
      @endforeach
    </select>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <br>
    <img src="{{asset('img/buku/'.$data->foto_buku)}}" width="100" height="100">
    <br>
